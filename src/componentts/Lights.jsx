...
// Now to show image of iphone, we first have to change its GLTF file to jsx file
// https://gltf.pmnd.rs/   // this is the link to convert gltf file to jsx file just go their and upload the file and download it our image is in public/models/scene.gltf

// So Step 9 is to go to src/componentts/IPhone.jsx and change the file to jsx file and then import it in Model.jsx
